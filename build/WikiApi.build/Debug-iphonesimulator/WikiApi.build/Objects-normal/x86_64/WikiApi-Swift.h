...
#ifndef WIKIAPI_SWIFT_H
#define WIKIAPI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WikiApi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7WikiApi11AppDelegate")
...
SWIFT_CLASS("_TtC7WikiApi13HomeViewModel")
...
SWIFT_CLASS("_TtC7WikiApi18MainViewController")
...
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified loaderStack;
- (void)viewDidLoad;
...
@interface MainViewController (SWIFT_EXTENSION(WikiApi)) <UISearchBarDelegate>
...
@interface MainViewController (SWIFT_EXTENSION(WikiApi)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC7WikiApi8NoteCell")
...
SWIFT_CLASS("_TtC7WikiApi13SceneDelegate")
